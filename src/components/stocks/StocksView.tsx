          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[9px] sm:text-[10px] font-bold px-1.5 py-0.5 sm:py-0.5 rounded-[var(--radius-pill)] bg-sky-500/15 text-sky-700 dark:text-sky-400 border border-sky-500/30 uppercase tracking-wider shrink-0">
                  Combined
                </span>
              </div>
