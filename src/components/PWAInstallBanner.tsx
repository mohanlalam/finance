...
export default function PWAInstallBanner() {
  ...
  return (
    <div className="fixed bottom-16 left-4 right-4 md:left-auto md:right-6 md:bottom-6 md:w-96 z-[250] animate-slide-up">
      ...
      <div className="bg-[var(--surface-solid)]/95 backdrop-blur-xl border border-[var(--border-subtle)] rounded-[var(--radius-large)] shadow-floating p-4 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-[var(--radius-medium)] bg-[var(--accent-blue)] text-white shadow-sm flex items-center justify-center shrink-0">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-6 h-6 text-white" aria-hidden="true">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button 
            ...
            aria-label={isIOS ? 'Show installation instructions for iOS' : 'Install Family Portfolio Tracker application'}
            className="px-4 py-2.5 min-h-[44px] min-w-[44px] bg-[var(--accent-blue)] hover:brightness-110 text-white text-xs font-bold rounded-[var(--radius-small)] shadow-sm active:scale-95 transition-all flex items-center justify-center touch-manipulation cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-blue)] focus-visible:ring-offset-2"
          >
          ...
          <button 
            ...
            className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-[var(--text-tertiary)] hover:text-[var(--text-primary)] rounded-full hover:bg-[var(--surface-secondary)] transition-colors touch-manipulation cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-blue)]"
