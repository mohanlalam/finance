          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="w-11 h-11 sm:w-8 sm:h-8 min-w-[44px] min-h-[44px] sm:min-w-[32px] sm:min-h-[32px] rounded-[var(--radius-small)] bg-[var(--accent-blue-soft)] text-[var(--accent-blue)] flex items-center justify-center hover:opacity-80 transition-opacity ios-press touch-manipulation cursor-pointer"
                title="Share Summary"
                aria-label="Share Portfolio Summary"
              >
                <Share2 size={14} />
              </button>
              <span className="w-11 h-11 sm:w-8 sm:h-8 min-w-[44px] min-h-[44px] sm:min-w-[32px] sm:min-h-[32px] rounded-[var(--radius-small)] bg-[var(--surface-secondary)] flex items-center justify-center">
