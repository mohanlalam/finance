...
export default function PortfolioAssistant({ portfolios }: PortfolioAssistantProps) {
  ...
  return (
    <div className="apple-card p-4 sm:p-5 text-slate-800 dark:text-slate-100 relative overflow-hidden flex flex-col min-h-[320px] sm:min-h-[370px] justify-between">
