...
export function FileCheck({ size = 24, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
...
export function Wallet({ size = 24, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
...
export function Fingerprint({ size = 24, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
...
export function ScanFace({ size = 24, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
