/**
 * AppIcons.tsx
 * Inline SVG replacements for every lucide-react icon used in AppShell and
 * AssetTabContent. Keeps the same prop signature as lucide components so
 * callers only need to change their import path, nothing else.
 *
 * Benefit: lucide-react (~600 KB) is excluded from the critical post-unlock
 * bundle. Lazy-loaded heavy view components can still import from lucide-react
 * independently and will only pull the lucide chunk on demand.
 */
