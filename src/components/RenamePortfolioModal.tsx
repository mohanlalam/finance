      ...
      <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <button
            ...
            disabled={submitting}
            onClick={onClose}
            className="flex-1 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-355 font-semibold text-sm rounded-xl py-2.5 hover:bg-slate-50 dark:hover:bg-slate-750 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
