...
interface RDViewProps {
  ...
  onAdd?: (assetType: string, portfolioName: string, payload: RDPayload | Record<string, unknown>) => Promise<unknown>;
  onUpdate?: (assetType: string, id: string, payload: Partial<RDPayload> | Record<string, unknown>) => Promise<void>;
