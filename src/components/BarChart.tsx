...
export default function BarChart({ portfolios }: BarChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
      <h3 className="text-sm font-semibold text-slate-600 uppercase tracking-wider mb-1">Invested vs Current Value</h3>
      <p className="text-xs text-slate-400 mb-4">Portfolio comparison</p>
      ...
      <div className="overflow-x-auto">
        ...
        >
          {Array.from({ length: yTicks + 1 }).map((_, i) => {
            ...
            return (
              <g key={i}>
                <line x1={paddingLeft - 8} y1={y} x2={paddingLeft + totalWidth - paddingLeft - 20} y2={y} stroke="#f1f5f9" strokeWidth={1} />
                <text x={paddingLeft - 12} y={y + 4} textAnchor="end" fill="#94a3b8" fontSize={9}>
          ...
          <line x1={paddingLeft} y1={paddingTop} x2={paddingLeft} y2={paddingTop + chartHeight} stroke="#e2e8f0" strokeWidth={1} />
          <line x1={paddingLeft} y1={paddingTop + chartHeight} x2={totalWidth - 10} y2={paddingTop + chartHeight} stroke="#e2e8f0" strokeWidth={1} />
          ...
          <g>
            ...
            <text x={paddingLeft + 18} y={paddingTop - 9} fill="#64748b" fontSize={10}>Invested</text>
            <rect x={paddingLeft + 72} y={paddingTop - 18} width={10} height={10} rx={2} fill="#10b981" />
            <text x={paddingLeft + 86} y={paddingTop - 9} fill="#64748b" fontSize={10}>Current Value</text>
          </g>
        </svg>
      </div>
    </div>
