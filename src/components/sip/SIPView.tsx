      ...
      <div className="apple-card p-3 sm:p-3.5 bg-[var(--surface)] border border-[var(--border-subtle)] space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[var(--border-subtle)] pb-2.5">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="w-8 h-8 rounded-[var(--radius-small)] bg-teal-500/20 text-teal-500 border border-teal-500/30 flex items-center justify-center shrink-0">
              <TrendingUp size={16} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-[var(--radius-pill)] bg-teal-500/15 text-teal-600 dark:text-teal-400 border border-teal-500/30 uppercase tracking-wider">
                  Combined
                </span>
              </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="bg-[var(--surface-secondary)] px-2.5 py-1 rounded-[var(--radius-small)] border border-teal-500/30 text-right">
              <span className="text-[10px] uppercase font-bold text-[var(--text-tertiary)] block">Monthly Inflow</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
          ...
          <div className="p-2 rounded-[var(--radius-small)] bg-[var(--surface-secondary)]/50 border border-[var(--border-subtle)]">
            <span className="text-[10px] font-bold text-[var(--text-tertiary)] uppercase tracking-wider block">Monthly SIP</span>
            <span className="text-xs sm:text-sm font-bold text-teal-500 tnum mt-0.5 block">
              {formatINR(familySIPSummary.totalMonthly)}/mo
            </span>
          </div>
          ...
          <div className="p-2 rounded-[var(--radius-small)] bg-[var(--surface-secondary)]/50 border border-[var(--border-subtle)]">
            ...
            <span className={`text-xs sm:text-sm font-bold tnum mt-0.5 block ${pnlColor(familySIPSummary.totalPnL)}`}>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1">
                          ...
                          {isSelected && (
                            <span className="text-[8.5px] font-bold px-1 rounded bg-teal-500/20 text-teal-600 dark:text-teal-400">
                              Active
                            </span>
                          )}
                        </div>
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-xs font-bold text-teal-500 tnum">
